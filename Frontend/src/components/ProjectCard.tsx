...
const ProjectCard: React.FC<CardProjectProps> = ({
  ...
  return (
    <article
      className="bg-gray-900 rounded-3xl border border-white/5 overflow-hidden 
      ...
      <div className="relative w-full md:w-4/12 lg:w-1/3 shrink-0 overflow-hidden flex items-center justify-center">
        ...
        {repoLink && (
          <a
            ...
            className="absolute top-1 right-3 bg-gray-900/80 p-2.5 rounded-full
                       hover:bg-blue-500 transition-colors
                       backdrop-blur-sm text-white shadow-md z-20"
          >
          ...
          {tags.map((tag, index) => (
            <span
              ...
              className="text-xs px-3 py-1 rounded-full
                         bg-blue-900/40 text-white border border-blue-800/30"
            >
              {tag}
            </span>
          ))}
