...
export default function Inicio() {
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[400px] bg-blue-500 opacity-45 blur-[90px] rounded-b-full z-0"></div>

      {/* Contenedor centrado */}
      <div className="max-w-5xl mx-auto p-2 relative z-10 flex flex-col md:flex-row items-center justify-center gap-16">
        ...
        <div className="flex-shrink-0">
          <img
            ...
            alt="Leonardo"
            className="w-45 h-45 rounded-full border-4 border-blue-500"
          />
        </div>
        ...
        <div className="text-center md:text-left max-w-3xl flex flex-col items-center md:items-start">
          ...
          <p className="typewriter text-xl font-bold text-blue-100 mb-6">
          ...
          <p className="text-gray-200 mb-8">
            ...
            desarrollado muchas habilidades que me han permitido crear soluciones a casos reales, basadas en las necesidades de los usuarios mediante diversas tecnologías.
          </p>
